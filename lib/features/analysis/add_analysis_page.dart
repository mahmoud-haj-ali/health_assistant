                        ...
                        showModalBottomSheet(context: context,
                          ...
                          builder: (context){
                            return Column(
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsets.fromLTRB(5.0.w, 2.0.h, 5.0.w, 0.0 ),
                                  child: InkWell(
                                    onTap: () {
                                    ...
                                    child: Ink(
                                      ...
                                      child: Center(child: Text("حذف الصورة")),
                                    ),
                                  ),
                                ),
                                Container(
                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(
                                          onTap: () async {
                                            Navigator.pop(context);
                                            image = (await getImage(true)) ?? image;
                                            setState((){});
                                          },
                                          borderRadius: BorderRadius.circular(10),
                                          child: Ink(
                                      ...
                                      Expanded(
                                        child: InkWell(
                                          onTap: () async {
                                            Navigator.pop(context);
                                            image = (await getImage(false)) ?? image;
                                            setState(() {});
                                          },
                                          borderRadius: BorderRadius.circular(10),
                                          child: Ink(
                      ...
                      CustomTextField(
                        ...
                        onIconClicked: ()async{
                          if(nameController.text.trim().isNotEmpty) {
                            if(!list.any((element) => element.name == nameController.text.trim())) {
