...
class CustomListTile extends StatelessWidget {
  ...
  final IconData icon;
  const CustomListTile({Key key, this.title, this.subtitle, this.onTap, this.onIconTap, this.icon}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: ListTile(
        ...
        leading: Icon(icon??Icons.person, size: 25, color: Theme.of(context).primaryColor,),
        trailing: IconButton(
