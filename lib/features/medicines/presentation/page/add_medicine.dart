                    ...
                    builder: (context) {
                      return RaisedButton(
                        onPressed: () async {
                          ...
                          if((await db.getAllMedicines).any((element) => element.name.trim() == controller.name)){
                            Scaffold.of(context).showSnackBar(
                                SnackBar(content: Text('الدواء موجود من قبل',
                          ...
                          bool isSuccess = await controller.saveMedicine(
                              id: widget.medicine?.id,amount: amount,isAfter: isAfter,notes: notes,range: range,unit: unit,times: times);
                          if(isSuccess){
